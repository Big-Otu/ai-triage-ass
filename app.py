...
if not st.session_state.authenticated:
    ...
    with col_m:
        ...
        st.markdown("---")
        st.caption("🔒 Authorised personnel only. Contact your system administrator for access credentials.")
...
with tab_history:
    ...
    if history_df.empty:
        ...
        st.dataframe(filtered.style.map(color_urgency, subset=['Urgency']), use_container_width=True, hide_index=True)
        st.markdown("---")
